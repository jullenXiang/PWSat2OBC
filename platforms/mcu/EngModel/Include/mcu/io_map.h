...
namespace io_map
{
    ...
    struct SPI : public SPIPins<SPI>
    {
        ...
        static const USART_TypeDef* Peripheral;
    ...
    struct ProgramFlash
    {
        static const std::uint8_t* FlashBase;
        static const std::uint8_t* ApplicatonBase;
    };

    struct RAMScrubbing
    {
        static const TIMER_TypeDef* TimerHW;
    ...
    template <> struct MemoryModule<1> : public PinGroupTag
    {
        ...
        static const ACMP_TypeDef* Comparator;
